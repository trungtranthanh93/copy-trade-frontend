    ...
    <q-page-container class="window-height">
      <div class="
        ...
        <div class="row items-center q-gutter-md justify-center">
          <q-btn color="negative" icon-right="cancel" style="" dense @click="unfollow()">Dừng follow</q-btn>
          <q-btn color="green" icon-right="cancel" style="" dense @click="continueFollow()">Tiếp tục</q-btn>
        </div>
        <q-separator color="dark" class="q-mt-md q-mb-md" inset />
        <div class="q-pa-md">
  ...
  export default {
    setup() {
      ...
      async function continueFollow() {
        ...
        $router.push('/user/setting-group/' + user.data.groupId);
      }
